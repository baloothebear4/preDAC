...
def make_font(name, size):
    ...
    try:
        return ImageFont.truetype(font_path, int(size))
            ...
            print("make_font > error, font files not found at ", font_path, e)
...
class frontOLED(OLEDdriver):
    ...
    WIDTH      = 256
    FPS        = 40
    config        = ['-i=spi', '--width=256', '--height=64','-d=ssd1322', '--spi-bus-speed=2000000']
    ...
    def __init__(self):
        ...
        #
        # self.testdevice()
        print("frontOLED.__init__> size", self.boundary)
