...
class Platform(VolumeBoard, ControlBoard, AudioBoard, \
                    RemoteController, AudioProcessor, KeyEvent):  #StreamerInterface removed
    ...
    def __init__(self, events):
        ...
        if self.internaldisplay is not None:
            hwifs = (ControlBoard, AudioBoard, VolumeBoard, AudioProcessor, KeyEvent, RemoteController)    #removed ->, StreamerInterface)
            for hw in hwifs:
                try:
